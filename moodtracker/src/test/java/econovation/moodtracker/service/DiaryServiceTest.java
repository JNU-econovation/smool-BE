...
class DiaryServiceTest {
    ...
    public void 일기찾기(){
        ...
        */
        ...
        List<Diary> allByTimeBetweenAndUserId = diaryRepository.findAllByTimeBetweenAndUserId(startTime, endTime, savedId);assertEquals(allByTimeBetweenAndUserId.size(), 1);
    }
    @Test
    //@Rollback(value = false)
    public void 일기수정(){
